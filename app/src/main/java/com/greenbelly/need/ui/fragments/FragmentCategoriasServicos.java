...
public class FragmentCategoriasServicos extends Fragment {
    ...
    public FragmentCategoriasServicos() {
    }
    ...
    private void populaLista(final ViewGroup container) {
        ...
        CategoriaService.getCategoriasLojas(ModalidadeTrabalho.PRESTADOR_SERVICOS, new SimpleCallback<List<CategoriaLoja>>() {
            @Override
